<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen">
    <header class="border-t-14 border-blue-600">
      <nav class="container mx-auto flex flex-col sm:flex-row justify-between items-center py-8">
        ...
        <ul class="uppercase tracking-wide font-bold w-full block flex-grow lg:space-x-8 lg:space-y-0 flex justify-around lg:flex-initial lg:w-auto items-center">
          <li>
            <!-- <g-link @click="showModal" to="/#modal" class="text-copy-primary hover:text-gray-600">CV</g-link> -->
  ...
  <modal  id="modal" name="jsonCV" :adaptive="true" :height="620" :class="show ? 'block': 'hidden'">
    ...
    <footer class="bg-blue-600 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="https://github.com/botdll" target="_blank" class="text-white hover:text-gray-400">
